...
export class CreateWillRequestDto {
  @ApiProperty({
    description: 'A descriptive title for the will.',
    example: 'Last Will and Testament of John Mwangi',
  })
  @IsString()
  @MinLength(3)
  @MaxLength(200)
  ...
  @IsOptional()
  @IsEnum(WillStatus)
  status: WillStatus = WillStatus.DRAFT;
}
...
export class UpdateWillRequestDto {
  ...
  @ApiPropertyOptional({
    description: 'The new status of the will.',
    enum: WillStatus,
  })
  @IsOptional()
  @IsEnum(WillStatus)
...
export class CreateAssetRequestDto {
  ...
  @IsEnum(AssetType)
  type: AssetType = AssetType.LAND_PARCEL;
}
...
export class AssignBeneficiaryRequestDto {
  ...
  @ApiProperty({
    description: 'The ID of the user who will be the beneficiary.',
  })
  @IsUUID()
...
export class AddFamilyMemberRequestDto {
  ...
  @ApiProperty({
    ...
    description: 'The relationship of this user to the family creator.',
  })
  @IsEnum(RelationshipType)
  role: RelationshipType = RelationshipType.OTHER;
}

export class UpdateFamilyMemberRequestDto {
  @ApiPropertyOptional({
    enum: RelationshipType,
    description: 'The new role of the family member.',
  })
  @IsOptional()
  @IsEnum(RelationshipType)
...
export class BeneficiaryAssignmentResponseDto extends BaseResponseDto {
  ...
  @ApiProperty({
    ...
    description: 'Details of the assigned asset.',
  })
...
export class FamilyMemberResponseDto extends BaseResponseDto {
  @ApiProperty()
  userId!: string;
