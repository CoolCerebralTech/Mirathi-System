// application/family/dto/request/update-family.request.ts
...
export class UpdateFamilyRequest {
  ...
  @ApiPropertyOptional({
    ...
    example: 'Updated family history including recent achievements',
    maxLength: 500,
  })
  description?: string;
  ...
  @IsOptional()
  @ApiPropertyOptional({
    description: 'User ID updating the family',
