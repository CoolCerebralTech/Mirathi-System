// application/family/commands/impl/remove-family-member.command.ts
import { ApiProperty } from '@nestjs/swagger';
import { IsNotEmpty, IsString, IsUUID } from 'class-validator';

import { BaseCommand } from '../base.command';

export class RemoveFamilyMemberCommand extends BaseCommand {
  @ApiProperty({
  ...
  @ApiProperty({
    description: 'Family member ID to remove',
  ...
  static create(
    ...
    return new RemoveFamilyMemberCommand(
