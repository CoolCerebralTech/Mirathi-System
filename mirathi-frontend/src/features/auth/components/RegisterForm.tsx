...
function PasswordRequirements({ password, show }: { password: string; show: boolean }) {
  // Only show when user has started typing or focused
  if (!show) return null;
    ...
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="text-center mb-10">
        ...
        <p className="mt-3 text-base text-slate-500 leading-relaxed">
          {t('auth:get_started_prompt', 'Secure your family legacy with Mirathi')}
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        {/* Consents - Styled for readability */}
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="bg-white px-4 text-slate-500 font-medium">
              {t('common:already_have_account', 'Already have an account?')}
            </span>
          </div>
        </div>
      ...
      <div className="mt-10 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-50 border border-slate-100">
          ...
          <span className="text-[11px] font-medium text-slate-500 uppercase tracking-wide">
            {t('auth:secured_registration', 'Secure Registration')}
          </span>
        </div>
      </div>
    </div>
