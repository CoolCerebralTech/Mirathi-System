...
export const UserIntentSelector: React.FC<UserIntentSelectorProps> = ({ onSelect }) => {
  return (
    <div className="grid gap-8 md:grid-cols-2 max-w-5xl mx-auto">
      ...
      {/* ================================================================== */}
      {/* OPTION A: ESTATE PLANNING (Living)                                 */}
      {/* ================================================================== */}
      <div 
        onClick={() => onSelect('PLANNING')}
        className={cn(
          "group relative cursor-pointer overflow-hidden rounded-xl border-2 border-transparent transition-all duration-300 bg-white shadow-sm",
      ...
      >
        ...
        <div className="p-8 flex flex-col h-full">
          ...
          <div className="mt-8 pt-6 border-t flex items-center font-bold text-[#C8A165] group-hover:gap-2 transition-all">
      ...
      {/* ================================================================== */}
      {/* OPTION B: ESTATE ADMINISTRATION (Deceased)                         */}
      {/* ================================================================== */}
      <div 
      ...
      >
        ...
        <div className="p-8 flex flex-col h-full">
          ...
          <div className="mt-8 pt-6 border-t flex items-center font-bold text-[#0F3D3E] group-hover:gap-2 transition-all">
