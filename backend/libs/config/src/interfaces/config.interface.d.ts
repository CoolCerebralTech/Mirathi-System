 ...
 */
export interface Config extends AppConfig, DatabaseConfig, ServicePortsConfig, ServiceUrlsConfig, AuthConfig, MessagingConfig, StorageConfig, EmailConfig, SmsConfig, ExternalServicesConfig, SecurityConfig, LoggingConfig {
}
