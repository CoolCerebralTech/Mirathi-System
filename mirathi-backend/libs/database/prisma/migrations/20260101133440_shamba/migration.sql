...
-- CreateEnum
CREATE TYPE "Language" AS ENUM ('ENGLISH', 'SWAHILI');
...
-- CreateIndex
CREATE INDEX "phone_verification_codes_userId_phoneNumber_idx" ON "phone_verification_codes"("userId", "phoneNumber");
